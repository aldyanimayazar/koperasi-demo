...
@section('content')
	<section class="content">
		<section class="content-header">
		    <h1><small>Preview Data Simpanan</small></h1>
		    <ol class="breadcrumb">
		        <li>
		  		...
		  		<div class="row">
		   			<div class="col-md-6 col-sm-6 col-xs-12">
		   				...
		   				<div class="form-group">
		   					...
		   					<span class="description" style="float: left;"><a href="{{ route('report.print', 'simpanan') }}" target="_blank" class="btn btn-warning pull-right"><i class="fa fa-print"></i> Print All</a></span>
		   				</div>
		  			</div>
		   			<div class="col-md-6 col-sm-6 col-xs-12">
			    		<!-- Form code begins -->
			    		<form method="post" action="{{ route('post.print') }}">
			    			{{ csrf_field() }}
			    			<input type="hidden" name="type" value="simpanan">
