...
@section('content')
	<section class="content">
		<section class="content-header">
		    <h1><small>Preview Data Pinjaman</small></h1>
		    <ol class="breadcrumb">
		        <li>
		        	<a href="home-admin.php"><i class="fa fa-dashboard"></i>Dashboard</a>
		        </li>
		        <li class="active">View Data Pinjaman</li>
		    </ol>
		</section>
		  		...
		  		<div class="row">
		   			<div class="col-md-6 col-sm-6 col-xs-12">
		   				...
		   				<div class="form-group">
		   					...
		   					<span class="description" style="float: left;"><a href="{{ route('report.print', 'pinjaman') }}" class="btn btn-warning pull-right"><i class="fa fa-print"></i> Print All</a></span>
		   				</div>
		  			</div>
		   			<div class="col-md-6 col-sm-6 col-xs-12">
			    		<!-- Form code begins -->
			    		<form method="post" action="{{ route('post.print') }}" target="_blank">
			    			{{ csrf_field() }}
			    			<input type="hidden" name="type" value="pinjaman">
