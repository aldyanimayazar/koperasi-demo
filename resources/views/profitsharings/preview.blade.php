...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-info" role="alert">
            <p>Catat dan simpan Nomor Transaksi. Periksa kembali detail Bagi Hasil dibawah ini sebelum print.</p>
        </div>
    </div>
    <div class="col-md-12">
        <div class="panel panel-headline">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th colspan="4"><span class="pull-right">Jumlah Bagi Hasil {{ ucwords($transaction->type_saving) }}</span></th>
            ...
            <div class="modal-footer">
                <a href="{{ route('profitsharing.index') }}" class="btn btn-dark waves-effect waves-light">Cancel</a>
