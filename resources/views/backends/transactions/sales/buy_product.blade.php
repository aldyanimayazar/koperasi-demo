    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('sales.buy.store') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('nik') ? ' has-error' : '' }}">
                        <label for="nik" class="col-sm-3 control-label">Member{!! trans('form.required') !!}</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="nik" id="nik" value="{{ $member->nik }}" disabled>
                        </div>
                    </div>

                    <div class="form-group{{ $errors->has('product_name') ? ' has-error' : '' }}">
                        <label for="product_name" class="col-sm-3 control-label">Nama Product{!! trans('form.required') !!}</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="product_name" id="product_name" value="{{ $product->name }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="amount" id="amount" min="0" maxlength="10" value="{{ $price[0] }}">
                        </div>
                    </div>
