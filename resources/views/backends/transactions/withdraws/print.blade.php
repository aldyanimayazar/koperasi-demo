  ...
  <body>
    ...
    <main>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <thead>
          <tr>
            <th class="desc">JUMLAH<br>WITHDRAW</th>
            <th class="unit">TIPE SIMPANAN</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td class="desc">{{ number_format($transaction->total, 2, ',', '.') }}</td>
            <td class="unit">{{ ucwords($transaction->type_saving) }}</td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
          ...
          <tr>
            <td colspan="2"></td>
            <td colspan="2">SISA SIMPANAN {{ ucwords($transaction->type_saving) }}</td>
            <td>{{ env('APP_CURRENCY', 'USD') }} {{ number_format($saving - $withdraw, 2, ',', '.') }}</td>
          </tr>
        </tfoot>
      </table>
