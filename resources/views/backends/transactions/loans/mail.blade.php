...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="http://koperasi.sektilab.xyz/front/assets/img/logo-sintesa.png">
      </div>
      <div id="company">
    ...
    <main>
      ...
      <div id="notices">
        <div>Catatan:</div>
        <div class="notice">{{ $transaction->note }}
          <br><br>
          Silahkan lihat detail Member pada link berikut:<br>
          <a href="#" target="_blank">Lihat Detail Member</a><br><br>
          Silahkan verifikasi:<br>
          <a href="#" target="_blank">ACCEPT</a> | <a href="#" target="_blank">REJECT</a><br><br><br>
        </div>
      </div>
    </main>
    <footer>
